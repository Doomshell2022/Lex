...
export default class SelectCardPendingPaymentScreen extends Component {
  constructor(props) {
    super(props);
  ...
  handleCardSelect = card => {
    if (card) {
      return () => {
        ...
        if (info) {
          this.props.navigation.push("CardPendingPayment", {
            info: { ...info, card }
          });
        }
      };
  ...
  handleUseAnotherCard = () => {
    ...
    if (info) {
      this.props.navigation.push("CardPendingPayment", { info: { ...info } });
    }
  };
